...
public class WheelView extends View {
    ...
    private void initPaints() {
        ...
        paintCenterText.setColor(getResources().getColor(R.color.pickerview_topbar_title));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int translateX = getResources().getDimensionPixelOffset(R.dimen.item_x_translate);
        canvas.translate(translateX, 0);

        //单位的Label
        if (label != null) {
            int deltaX = getResources().getDimensionPixelSize(R.dimen.label_x_offset);
            int drawRightContentStart = measuredWidth - getTextWidth(paintCenterText, label) - deltaX;
            //靠右并留出空隙
